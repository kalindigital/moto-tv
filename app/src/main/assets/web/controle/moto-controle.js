...
import { serializePick } from '../shared/cue-protocol.js'
...
function connect() {
  ...
  ws.onopen = () => {
    ...
    // Avisa o menu da TV para abrir o jogo da moto (ignorado se já estiver nele).
    enviar(serializePick('moto'))
...
// Sair: manda a TV de volta ao menu e recarrega o celular no seletor de jogos.
document.getElementById('sair').addEventListener('click', () => {
  enviar(serializeAction('menu'))
  soltar()
